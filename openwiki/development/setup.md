...
This guide explains how to set up a development environment for contributing to Herdr Connect. For users who just want to try the preview, see the "Try it in 5 minutes" section of the repository `README.md`.
