/**
 * Agents 列表过滤的跨布局接线(issue #56 / #57 / #58)。
 *
 * 过滤选择(状态组 + workspace + 「仅看收藏」开关)属于每实例界面记忆
 * (instance-ui-state 的 agentFilter 槽位),该 reducer 提升在
 * AppShell(窄屏导航树与宽屏 SplitLayout 之上)。列表页 AgentsScreenContent 是宽窄两树的共同挂载点,
